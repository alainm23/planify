...
public class Dialogs.ShortcutsDialog : Gtk.Dialog {
    ...
    construct {
        ...
        column.attach (new Widgets.ShortcutLabel (shortcut_hint.split ("+")), 0, 7);
        ...
        column.attach (new Widgets.ShortcutLabel ({"Ctrl", "f"}), 0, 10);
        column.attach (new NameLabel (_("Open Quick Find")), 1, 10);
        column.attach (new Widgets.ShortcutLabel ({"any key"}), 0, 11);
        column.attach (new NameLabel (_("Start typing to begin a search")), 1, 11);
        column.attach (new Widgets.ShortcutLabel ({"p1, p2, p3"}), 0, 12);
        column.attach (new NameLabel (_("Filter by priorities")), 1, 12);
        column.attach (new Widgets.ShortcutLabel ({_("Labels")}), 0, 13);
        column.attach (new NameLabel (_("Quick Find list for all labels")), 1, 13);
        column.attach (new Widgets.ShortcutLabel ({_("Projects")}), 0, 14);
        column.attach (new NameLabel (_("Quick Find list for all projects")), 1, 14);
        column.attach (new Widgets.ShortcutLabel ({_("Completed")}), 0, 15);
        ...
        column.attach (new Widgets.ShortcutLabel ({"Ctrl", "q"}), 0, 17);
        column.attach (new NameLabel (_("Quit")), 1, 17);
        column.attach (new Widgets.ShortcutLabel ({"Ctrl", ","}), 0, 18);
        column.attach (new NameLabel (_("Open Preferences")), 1, 18);
        column.attach (new Widgets.ShortcutLabel ({"f1"}), 0, 19);
        ...
        column.attach (new Widgets.ShortcutLabel ({"Ctrl", "1"}), 0, 21);
        column.attach (new NameLabel (_("Open Inbox")), 1, 21);
        column.attach (new Widgets.ShortcutLabel ({"Ctrl", "2"}), 0, 22);
        column.attach (new NameLabel (_("Open Today")), 1, 22);
        column.attach (new Widgets.ShortcutLabel ({"Ctrl", "3"}), 0, 23);
