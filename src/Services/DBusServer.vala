...
[DBus (name = "com.github.alainm23.planify")]
public class Services.DBusServer : Object {
    private const string DBUS_NAME = "com.github.alainm23.planify";
    private const string DBUS_PATH = "/com/github/alainm23/planify";
