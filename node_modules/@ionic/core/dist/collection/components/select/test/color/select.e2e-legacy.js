...
test.describe('input: color', () => {
  ...
  test.describe('input: fill none', () => {
    test('should set label and highlight color on expand', async ({ page }) => {
      ...
      expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(`select-no-fill-color-${page.getSnapshotSettings()}.png`);
    });
  });
  test.describe('input: fill solid', () => {
    test('should set label and highlight color on expand', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(`select-solid-color-${page.getSnapshotSettings()}.png`);
    });
  });
  test.describe('input: fill outline', () => {
    test('should set label and highlight color on expand', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(`select-outline-color-${page.getSnapshotSettings()}.png`);
    });
  });
});
