...
test.describe('select: basic', () => {
  ...
  test.describe('select: alert', () => {
    test('it should open an alert select', async ({ page }) => {
      ...
      expect(await page.screenshot({ animations: 'disabled' })).toMatchSnapshot(`select-alert-diff-${page.getSnapshotSettings()}.png`);
      const alert = page.locator('ion-alert');
      await alert.evaluate((el) => el.dismiss());
  ...
  test.describe('select: action sheet', () => {
    test('it should open an action sheet select', async ({ page }) => {
      ...
      expect(await page.screenshot({ animations: 'disabled' })).toMatchSnapshot(`select-action-sheet-diff-${page.getSnapshotSettings()}.png`);
...
test.describe('select: ionChange', () => {
  ...
  test('should not fire when programmatically setting a valid value', async ({ page }) => {
    ...
    const ionChange = await page.spyOnEvent('ionChange');
    const select = page.locator('ion-select');
    await select.evaluate((el) => (el.value = 'banana'));
