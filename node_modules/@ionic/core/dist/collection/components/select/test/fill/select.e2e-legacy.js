...
test.describe('select: fill', () => {
  ...
  test.describe('select: fill solid', () => {
    ...
    test('should render correctly with floating label', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-fill-solid-label-floating-${page.getSnapshotSettings()}.png`);
    });
    ...
    test('padding and border radius should be customizable', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-fill-shaped-solid-custom-${page.getSnapshotSettings()}.png`);
    });
  });
  test.describe('select: fill outline', () => {
    ...
    test('should render correctly with floating label', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-fill-outline-label-floating-${page.getSnapshotSettings()}.png`);
    });
    ...
    test('padding and border radius should be customizable', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-fill-shaped-outline-custom-${page.getSnapshotSettings()}.png`);
    });
  });
});
