...
test.describe('select: label', () => {
  test.describe('select: start placement', () => {
    test('should render a start justification with label in the start position', async ({ page }) => {
      ...
      expect(await select.screenshot()).toMatchSnapshot(`select-label-start-justify-start-${page.getSnapshotSettings()}.png`);
    });
    test('should render an end justification with label in the start position', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-start-justify-end-${page.getSnapshotSettings()}.png`);
    });
    test('should render a space between justification with label in the start position', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-start-justify-space-between-${page.getSnapshotSettings()}.png`);
    });
  });
  test.describe('select: end placement', () => {
    test('should render a start justification with label in the end position', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-end-justify-start-${page.getSnapshotSettings()}.png`);
    });
    test('should render an end justification with label in the end position', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-end-justify-end-${page.getSnapshotSettings()}.png`);
    });
    test('should render a space between justification with label in the end position', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-end-justify-space-between-${page.getSnapshotSettings()}.png`);
    });
  });
  test.describe('select: fixed placement', () => {
    test('should render a start justification with label in the fixed position', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-fixed-justify-start-${page.getSnapshotSettings()}.png`);
    });
    test('should render an end justification with label in the fixed position', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-fixed-justify-end-${page.getSnapshotSettings()}.png`);
    });
    test('should render a space between justification with label in the fixed position', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-fixed-justify-space-between-${page.getSnapshotSettings()}.png`);
    });
  });
  test.describe('select: floating placement', () => {
    test('label should appear above the select when there is a value', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-floating-value-${page.getSnapshotSettings()}.png`);
    });
    test('label should appear on top of the select when there is no value', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-floating-no-value-${page.getSnapshotSettings()}.png`);
    });
    test('label should appear on top of the select when there is a placeholder and no value', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-floating-no-value-placeholder-${page.getSnapshotSettings()}.png`);
    });
    test('label should appear on top of the select when the select is expanded', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(`select-label-floating-expanded-${page.getSnapshotSettings()}.png`);
    });
    test('long text should truncate', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(`select-label-floating-long-text-${page.getSnapshotSettings()}.png`);
    });
  });
  test.describe('select: stacked placement', () => {
    ...
    test('label should appear above the select when there is no value', async ({ page }) => {
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot()).toMatchSnapshot(`select-label-stacked-no-value-${page.getSnapshotSettings()}.png`);
    });
    test('label should appear on top of the select when the select is expanded', async ({ page }) => {
      await page.setContent(`
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(`select-label-stacked-expanded-${page.getSnapshotSettings()}.png`);
    });
    test('long text should truncate', async ({ page }) => {
      await page.setContent(`
      ...
      `);
      const select = page.locator('ion-select');
      expect(await select.screenshot({ animations: 'disabled' })).toMatchSnapshot(`select-label-stacked-long-text-${page.getSnapshotSettings()}.png`);
    });
  });
