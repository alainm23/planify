...
test.describe('toggle: label', () => {
  test.describe('toggle: start placement', () => {
    test('should render a start justification with label in the start position', async ({ page }) => {
      ...
      expect(await toggle.screenshot()).toMatchSnapshot(`toggle-label-start-justify-start-${page.getSnapshotSettings()}.png`);
    });
    test('should render an end justification with label in the start position', async ({ page }) => {
      ...
      `);
      const toggle = page.locator('ion-toggle');
      expect(await toggle.screenshot()).toMatchSnapshot(`toggle-label-start-justify-end-${page.getSnapshotSettings()}.png`);
    });
    test('should render a space between justification with label in the start position', async ({ page }) => {
      ...
      `);
      const toggle = page.locator('ion-toggle');
      expect(await toggle.screenshot()).toMatchSnapshot(`toggle-label-start-justify-space-between-${page.getSnapshotSettings()}.png`);
    });
  });
  test.describe('toggle: end placement', () => {
    test('should render a start justification with label in the end position', async ({ page }) => {
      ...
      `);
      const toggle = page.locator('ion-toggle');
      expect(await toggle.screenshot()).toMatchSnapshot(`toggle-label-end-justify-start-${page.getSnapshotSettings()}.png`);
    });
    test('should render an end justification with label in the end position', async ({ page }) => {
      ...
      `);
      const toggle = page.locator('ion-toggle');
      expect(await toggle.screenshot()).toMatchSnapshot(`toggle-label-end-justify-end-${page.getSnapshotSettings()}.png`);
    });
    test('should render a space between justification with label in the end position', async ({ page }) => {
      ...
      `);
      const toggle = page.locator('ion-toggle');
      expect(await toggle.screenshot()).toMatchSnapshot(`toggle-label-end-justify-space-between-${page.getSnapshotSettings()}.png`);
    });
  });
  test.describe('toggle: fixed placement', () => {
    test('should render a start justification with label in the fixed position', async ({ page }) => {
      ...
      `);
      const toggle = page.locator('ion-toggle');
      expect(await toggle.screenshot()).toMatchSnapshot(`toggle-label-fixed-justify-start-${page.getSnapshotSettings()}.png`);
    });
    test('should render an end justification with label in the fixed position', async ({ page }) => {
      ...
      `);
      const toggle = page.locator('ion-toggle');
      expect(await toggle.screenshot()).toMatchSnapshot(`toggle-label-fixed-justify-end-${page.getSnapshotSettings()}.png`);
    });
    test('should render a space between justification with label in the fixed position', async ({ page }) => {
      ...
      `);
      const toggle = page.locator('ion-toggle');
      expect(await toggle.screenshot()).toMatchSnapshot(`toggle-label-fixed-justify-space-between-${page.getSnapshotSettings()}.png`);
    });
  });
});
