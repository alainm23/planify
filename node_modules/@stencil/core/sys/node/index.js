/*!
 Stencil Node System v3.2.2 | MIT Licensed | https://stenciljs.com
 */
 ...
 e.exports = function(e) {
  ...
  let q = (O = (0, (d || n()).default)((function*(e, t, r, i) {
   ...
   yield (b || a()).queue(h, (function(e) {
    ...
    return t.verbose(t.lang("verboseFileSymlink", e.dest, r)), X(r, e.dest);
   }));
  })), function e(t, r, n) {
  ...
  Object.defineProperty(t, "__esModule", {
   ...
   return function i(e) {
    return e.includes(T) && e.includes(C) && e.includes(L);
   }(e = (0, (c || function n() {
    return c = s(r(122));
     ...
     for (;r.length; ) {
      ...
      if (e.startsWith(T)) {
       for (;r.length; ) {
        ...
        n || e.startsWith(k) ? n = !0 : t[0].push(e);
       }
       for (;r.length; ) {
        const e = r.shift();
        if (e.startsWith(L)) break;
        t[1].push(e);
       }
  ...
  const p = /^yarn lockfile v(\d+)$/, d = "BOOLEAN", m = "STRING", g = "EOF", y = "COLON", E = "NEWLINE", v = "COMMENT", b = "INDENT", _ = "INVALID", w = "NUMBER", S = "COMMA", O = [ d, m, w ];
  class A {
   constructor(e, t = "lockfile") {
    this.comments = [], this.tokens = function* r(e) {
     ...
     for (;e.length; ) {
      let s = 0;
      if ("\n" === e[0] || "\r" === e[0]) s++, "\n" === e[1] && s++, n++, i = 0, yield t(E); else if ("#" === e[0]) {
       s++;
       let r = "";
       for (;"\n" !== e[s]; ) r += e[s], s++;
       yield t(v, r);
       ...
       s = r.length, yield t(b, r.length / 2);
      } else s++; else if ('"' === e[0]) {
       let r = "";
       for (let t = 0; ;t++) {
        const n = e[t];
       ...
       s = r.length, yield t(w, +r);
      } else if (/^true/.test(e)) yield t(d, !0), s = 4; else if (/^false/.test(e)) yield t(d, !1), 
      s = 5; else if (":" === e[0]) yield t(y), s++; else if ("," === e[0]) yield t(S), 
...
class SemVer {
 constructor(e, t) {
  if (t = parseOptions_1(t), e instanceof SemVer) {
   ...
   e = e.version;
  } else if ("string" != typeof e) throw new TypeError(`Invalid Version: ${require$$1__default.default.inspect(e)}`);
