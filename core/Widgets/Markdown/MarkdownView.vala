...
public class Widgets.Markdown.View : GtkSource.View {
    ...
    private string create_filtered_buffer (string buffer_text) {
        ...
        if (buffer_text == null || buffer_text.length <= 5) {
            return buffer_text;
        }
    ...
    void format_horizontal_rule (string buffer_text,
                                 out MatchInfo matches) throws RegexError {
    ...
    void format_blockquote (string buffer_text,
                            out MatchInfo matches) throws RegexError {
        // Check for code blocks
    ...
    void format_escape_format (string buffer_text,
                               out MatchInfo matches) throws RegexError {
        // Check for escapes
    ...
    void format_escape_cursor (string buffer_text,
                               Gtk.TextIter cursor_location,
                               out MatchInfo matches) throws RegexError {
        // Check for escapes
        if (is_escape.match_full (buffer_text, buffer_text.length, 0, 0, out matches)) {
    ...
    void format_code_block_format (string buffer_text,
                                   out MatchInfo matches) throws RegexError {
        // Check for code blocks
    ...
    void format_code_block_cursor (string buffer_text,
                                   Gtk.TextIter cursor_location,
                                   out MatchInfo matches) throws RegexError {
        // Check for code blocks
        if (is_code_block.match_full (buffer_text, buffer_text.length, 0, 0, out matches)) {
    ...
    void do_formatting_pass_format (Regex regex,
                                    Gtk.TextTag text_tag,
                                    string buffer_text,
                                    out MatchInfo matches,
                                    bool remove_other_tags = false) throws RegexError {
    ...
    void do_formatting_pass_cursor (Regex regex,
                                    string buffer_text,
                                    Gtk.TextIter cursor_location,
                                    out MatchInfo matches,
                                    bool remove_other_tags = false) throws RegexError {
